...
Electron desktop app (TypeScript + React) for capital gains tracking.

Epic-flow process mirrored from [davgor.github.io](https://github.com/davgor/davgor.github.io). Packaging and deployment capabilities mirrored from [AI-DND-Matrix](https://github.com/davgor/AI-DND-Matrix).
...
2. Package on `windows-latest` (`CapitalGains-Setup-*.exe` NSIS + portable) and `macos-latest` (`.dmg`)
